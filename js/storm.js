...
(function () {
  ...
  function drawTitleBlock(t) {
    ...
    label('SCOPE OF LOSS', x + 10, y + 11, 11, AMBER, t);
    label('SHEET 03', x + 178, y + 11, 11, MUTED, t);
    label('RACCOON RESTORATION', x + 10, y + 38, 11, INK, t);
    label('HAIL / WIND', x + 10, y + 52, 10, MUTED, t);
    label('REV. A', x + 178, y + 38, 10, MUTED, t);
  }
